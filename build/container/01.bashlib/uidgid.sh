...
function uidgid.createUserAndGroup()
{
    ...
    local user="$( lib.indirect_reference $name 'user' )"
    local uid="$( lib.indirect_reference $name 'uid' )"
    local group="$( lib.indirect_reference $name 'group' )"
    local gid="$( lib.indirect_reference $name 'gid' )"
    local homedir="$( lib.indirect_reference $name 'home' )"
    local shell="$( lib.indirect_reference $name 'shell' )"
